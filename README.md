...
### Head of AI & Automation — The Hustle House
`Oct 2025 – Present`

- Leading AI integrations, automation pipelines, and intelligent workflow systems
- Owning technical decisions, sprint planning, and mentoring the dev team
- Stack: `React` `Node.js` `Python` `AI integrations` `Automation pipelines`

### Full Stack Developer — Royal IT Services
`Jul 2025 – Sep 2025 · 3 months`

- Fast-paced client delivery across multiple projects
- Expanded into Python backend with FastAPI
- Stack: `React` `Node.js` `FastAPI` `Python`

### Full Stack Developer Intern — Black Grape Softech
`Jan 2025 – Jun 2025 · 6 months`

- Built and shipped full-stack features in a production environment
- Gained hands-on experience with the MERN stack and agile development
...
|---|---|---|
| [Black-Grapes-HRMS](https://github.com/blackgrapes/Black-Grapes-HRMS) | Full-featured HR Management System | React, Node.js, MongoDB |
| [Invention Success Predictor](https://github.com/blackgrapes/Invention-Success-Prediction-api-test) | Backend platform for scientists to submit & track inventions | Node.js, ML API |
| [SiddhiClassess Payslip Generator](https://github.com/blackgrapes/SiddhiClassess-payslipGenerator) | Automated payslip system for a coaching institute | Node.js, MongoDB |
| [magicbrickclone](https://github.com/0sourabh/magicbrickclone) | Real estate listing platform clone | React, Node.js |
